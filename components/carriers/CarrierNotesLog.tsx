...
import type { CarrierNote } from "@/lib/types";
import DeleteButton from "@/components/DeleteButton";

export default function CarrierNotesLog({
  notes,
  createNote,
  deleteNote,
}: {
    ...
    <div className="panel p-5">
      ...
      <form
        action={async (fd) => {
          ...
          await createNote(fd);
          setPending(false);
          const el = document.getElementById("carrier-note-content") as HTMLTextAreaElement | null;
          if (el) el.value = "";
        }}
        className="mb-5"
      >
        <textarea
          id="carrier-note-content"
          name="content"
          rows={3}
          required
